...
and female speakers. All smooths were found to be significant in the original
paper. To match the previous plots for _this_ paper, we manually add a "*" to
the labels to indicate this.
...
For this PCA, the variable loadings for PC1 is in the opposite direction for
Brand et al (2021). We will change it here to keep it consistent to Brand et al
(2021). Recall that the direction of a PC is arbitrary.
...
Again for QB2, the variable loadings for PC1 is in the opposite direction for
Brand et al (2021). We will change it here to keep it consistent to Brand et al
(2021).
